...
- Tests: Has the javascript based tests created on playwright
- Evidence: Has the evidence gathered from testing. Folders are separated per requirement.

Requirements
- QT-1: Login & access control
- QT-2: Employee Management 
- QT-3: Leave Management